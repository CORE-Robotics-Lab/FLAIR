...
class AIRL(SingleTimestepIRL):
    ...
    def __init__(self, env,
        ...
        with tf.variable_scope(name) as _vs:
            ...
            self.value_loss = tf.reduce_mean(tf.losses.huber_loss(tf.stop_gradient(self.reward + self.gamma * fitted_value_fn_n), fitted_value_fn))
    ...
    def fit(self, paths, policy=None, batch_size=32, logger=None, lr=1e-3, **kwargs):
        ...
        if logger:
            ...
            with logger.tabular_prefix("AIRL_owntau | "):
                ...
                logger.record_tabular('loss_cent', log_cent_loss)
                logger.record_tabular('loss_value', log_value_loss)
