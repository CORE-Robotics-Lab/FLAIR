...
"""
Load expert demonstrations for DMSRD
There are 3 possible squeeze options-
0: Corresponds to standard Inverted Pendulum dataset
1: Corresponds to 100 demonstration dataset
2: Corresponds to Lunar Lander dataset
"""
def load_expert_from_core_MSD(filename, length, repeat_each_skill, separate_styles, squeeze_option=0):
