...
if __name__ == "__main__":
    ...
    ax[0].axhline(y=-6144.8, color='black', linestyle='--', lw=3, label='FLAIR on 10 Demos')
    ax[0].axhline(y=-30637.2, color='green', linestyle='--', lw=3, label='AIRL on 10 Demos')
    ax[0].axhline(y=-74166.0, color='yellow', linestyle='--', lw=3, label='MSRD on 10 Demos')
    ...
    ax[1].axhline(y=-51929.3, color='black', linestyle='--', lw=3,
                  label='FLAIR on 10 Demos')
    ax[1].axhline(y=-48162.6, color='green', linestyle='--', lw=3,
                  label='AIRL on 10 Demos')
    ax[1].axhline(y=-88557.8, color='yellow', linestyle='--', lw=3,
    ...
    ax[2].axhline(y=12.5, color='black', linestyle='--', lw=3,
                  label='FLAIR on 10 Demos')
    ax[2].axhline(y=13.0, color='green', linestyle='--', lw=3,
                  label='AIRL on 10 Demos')
    ax[2].axhline(y=32.6, color='yellow', linestyle='--', lw=3,
                  label='MSRD on 10 Demos')
    ...
    ax[3].axhline(y=0.582, color='black', linestyle='--', lw=3,
                  label='FLAIR on 10 Demos')
    ax[3].axhline(y=0.281, color='green', linestyle='--', lw=3,
                  label='AIRL on 10 Demos')
    ax[3].axhline(y=0.401, color='yellow', linestyle='--', lw=3,
                  label='MSRD on 10 Demos')
    ...
    fig.suptitle("100 Demonstration Bipedal Walker", y=1.0, fontsize=17, weight='bold')
    ...
    plt.savefig("data/figs/scaling_experiment_biwalker_results.png")
    plt.close(fig)
